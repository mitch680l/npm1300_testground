...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LTE_LC_PERIODIC_SEARCH_MODULE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LTE_LC_PSM_MODULE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LTE_LC_RAI_MODULE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LTE_LC_MODEM_SLEEP_MODULE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LTE_LC_TAU_PRE_WARNING_MODULE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LTE_NETWORK_MODE_DEFAULT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LTE_LC_TAU_PRE_WARNING_THRESHOLD_MS, 10240);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LTE_LC_MODEM_SLEEP_NOTIFICATIONS_THRESHOLD_MS, 10240);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_CMD_BUFF_SIZE, 2524);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_ARGC_MAX, 70);
